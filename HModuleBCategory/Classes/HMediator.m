...
NSString * const kHMediatorParamsKeySwiftTargetModuleName = @"kHMediatorParamsKeySwiftTargetModuleName";
@interface HMediator ()

@property (nonatomic, strong) NSMutableDictionary *cachedTarget;

@end
@implementation HMediator
#pragma mark - public methods
+ (instancetype)sharedInstance {
    static HMediator *mediator;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mediator = [[HMediator alloc] init];
    });
    return mediator;
}
